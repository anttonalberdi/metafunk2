...
def bin_refinement(projectname,projectpath,threads,memory,logfilepath):
    ...
    dastoolCmd = ''+dastoolDependencies+' && DAS_Tool -i '+bincontig_tables+' -c '+reassemblypath+' -o '+dastoolpath+' --search_engine diamond -t '+threads+' --db_directory '+dastooldb+' --write_bins 1'
