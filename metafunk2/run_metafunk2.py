...
required.add_argument('-n', help="Sample name",nargs='+', dest="name", required=True)
required.add_argument('-1', help="KEGG database path",nargs='+', dest="read1", required=True)
required.add_argument('-2', help="KEGG database path",nargs='+', dest="read2", required=True)
required.add_argument('-r', help="Reference genome (RF) sequence name(s) and path(s). RF1name=RF1path,RF2name=RF2path, etc.",nargs='+', dest="refgen", required=True)
required.add_argument('-o', help="Output path", nargs='+',dest="outpath", required=True)
optional.add_argument('-t', help="Number of threads", nargs='?', dest="threads", default=8)
optional.add_argument('-m', help="RAM memory limit", nargs='?', dest="memory", default=250)
optional.add_argument('-k', help="Keep intermediate files", dest="keep", action='store_true',default=True)
optional.add_argument('--skipsteps', help="Skip steps", nargs='?', dest="skipsteps", type=int)
optional.add_argument('--includesteps', help="Include steps", nargs='?', dest="includesteps", type=int)
