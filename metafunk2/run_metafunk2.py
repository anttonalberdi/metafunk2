...
parser.add_argument('-t', help="Number of threads", nargs='?', metavar="THREADS", dest="threads", default=8)
parser.add_argument('-m', help="RAM memory limit", nargs='?', metavar="MEMORY", dest="memory", default=250)
