...
xqsub -V -A ku-cbd -W group_list=ku-cbd -d `pwd` -e ${workdir}/binning.err -o ${workdir}/binning.out -l nodes=1:ppn=8,mem=20gb,walltime=0:02:00:00 -N binning -de python metafunk2/metafunk2.py -n AI0_11b -1 metafunk2_test2/AI0_11b_1.fastq.gz -2 metafunk2_test2/AI0_11b_2.fastq.gz -r 'gambusia=databases/GCA_003097735.1_ASM309773v1_genomic.fna.gz,human=databases/GCF_000001405.39_GRCh38.p13_genomic.fna.gz' -o /home/projects/ku-cbd/people/antalb/metafunk2_test -t 8 -m 8 -i 4 -k
